...
bool DUT::ShowVideo2K(){
	if(DockRun(_T("video black"))){
		Delay(300);
		if(DockRun(_T("video bitmap .\\RGB.bmp -m 1920 1080 60")))
		{
			Delay(300);
			return DockRun(_T("video bitmap .\\RGB.bmp -m 1920 1080 60 --head 1"));// jim 20161102 遇到兩個head的情況
		}
	}
	else{
